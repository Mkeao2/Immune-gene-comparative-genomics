...
2. Match the longest isoform gene names with gene symbol, transcript ID and protein ID (file 1).

3. Run the following to get a list of genes with all immune associated GO terms (file 2). 
